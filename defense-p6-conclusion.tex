\begin{frame}
   ...
   \begin{itemize}
   \item {\bf LazySP} algorithm for graphs with expensive edge evaluations
   \item {\bf IBiD} algorithm for incremental bidirectional search
   \item {\bf LEMUR} algorithm for motion planning with utility functions
   \item {\bf C-space family decomposition} for multi-step planning tasks
   \end{itemize}
