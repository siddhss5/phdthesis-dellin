\begin{frame}
   ...
   \begin{tikzpicture}[font=\small]
      ...
      \node[align=center,fill=black!5,rounded corners,minimum width=2.5cm] at (3,1.75)
      {\begin{minipage}{3.5cm}
         ...
         \vspace{-0.4cm}
         \[
            x(e) = \left\{ \arraycolsep=2pt \begin{array}{cl}
               ||e|| & e \in C_{\ms{free}} \\
      ...
      \node[align=center,fill=black!5,rounded corners,minimum width=5cm] at (9.0,1.75)
      {\begin{minipage}{4.5cm}
         For LEMUR:
         \vspace{-0.2cm}
         \[
            w_{\ms{est}}(e) = \lambda_U \, \grave{p}(e) + (1 - \lambda_U) \, \hat{x}(e)
         \]
         \vspace{-0.5cm}
         \[
            w(e) = (1 - \lambda_U) \, x(e)
         \]
         \[
            h_w(q_a, q_b) = (1 - \lambda_U) \, h_x(v_a, v_b)
         \]
      \end{minipage}};
...
\begin{frame}
   ...
   \begin{tikzpicture}[font=\small]
      ...
      \node[draw=black,fill=black!2,anchor=north] at (7.8,7.325) {\strut $h_w = (1 - \lambda_U) \, h_x$};
   ...
   \begin{tikzpicture}[font=\small]
      ...
      \node[inner sep=0pt,anchor=north] at (6,2.3) {\begin{minipage}{10.9cm}
         ...
         \item {\only<8-9>{\color{gray}}
            Non-Incremental and Incremental methods both create a \emph{trust region (TR)}}
         \item {\color{gray}
...
\begin{frame}
   ...
   \begin{tikzpicture}[font=\small]
      ...
      \node[inner sep=0pt,anchor=north] at (6,2.3) {\begin{minipage}{10.9cm}
         {\bf 3 Key Insights:}
         \begin{itemize}
         \item Non-Incremental and Incremental methods both create a \emph{trust region (TR)}
