...
\begin{frame}
   ...
   \begin{tikzpicture}[font=\small]
      ...
      \node[draw=black!30,inner sep=0pt] (exibid) at (4.7,1.2) {
         \includegraphics[width=2.7cm]{figs/incbi-road-ne/singleshot/example-incbi-1.png}};
      ...
      \begin{scope}
         \clip (0,0) rectangle (12,8);
         \node at (9.2,3.7) {\includegraphics{build/incbi-road-ne/stats2vert-nonheur}};
      \end{scope}
      ...
      \node[fill=blue!50,draw=black,inner sep=4pt] (first) at (7.0,7.7) {};
      \node[anchor=west,right=0cm of first.east] {\strut first ep};

      \node (oftenrare) at (10.4,7.7) {\strut $\leftarrow$ often rare $\rightarrow$};
      \node[fill=colora,draw=black,inner sep=4pt,anchor=east,left=0cm of oftenrare.west] {};
      \node[fill=colord,draw=black,inner sep=4pt,anchor=west,right=0cm of oftenrare.east] {};
...
\begin{frame}
   ...
   \node[fill=black!5,draw=black!10,rounded corners,align=center] (blocka) at (7.3,6.6) {
      \strut $w : E \rightarrow \mathbb{R}$};

   \only<2->{
   \node[fill=black!5,draw=black!10,rounded corners,align=center] (blockb) at (7.3,5.5) {
      Vertex potential:\\
   ...
   \only<3->{
   \node[fill=black!5,draw=black!10,rounded corners,align=center] (blockc) at (7.3,4.2) {
      \strut $w' : E \rightarrow \mathbb{R}$\\
   ...
   \only<4->{
   \node[fill=blue!10,draw=blue!20,rounded corners,align=center] at (8.5,1.8) {
   ...
   \only<5->{
   \node[fill=blue!10,draw=blue!20,rounded corners,align=center] (blockd) at (10.7,4.2) {
      Shortest path\\ \strut $p'_{st}$ w.r.t. $w'$};
   \draw[->] (blockc) -- (blockd);
   }

   \only<6->{
   \node[fill=blue!10,draw=blue!20,rounded corners,align=center] (blocke) at (10.7,6.6) {
...
\begin{frame}
   ...
   \node[fill=black!5,minimum width=5.2cm] at (3.7,7.55) {\strut Non-Incremental};
   \node[fill=black!5,minimum width=3.3cm,rotate=90] at (0.6,5.45) {\strut Unidirectional};
   \only<3->{\node[fill=black!5,minimum width=5.2cm] at (9.0,7.55) {\strut Incremental};}
   \only<11->{\node[fill=black!5,minimum width=3.45cm,rotate=90] at (0.6,1.85) {\strut Bidirectional};}
   ...
   \only<11>{
      \node[fill=blue!5,anchor=north,rounded corners,minimum width=5cm,minimum height=0.5cm,below=0.5cm of bidijk.north] {};
   }
   \only<11-12>{
...
\begin{frame}
   ...
   \begin{tikzpicture}[font=\small]
      ...
      \node[fill=blue!50,draw=black,inner sep=4pt] (first) at (5.5,7.0) {};
      \node[anchor=west,right=0cm of first.east] {\strut first ep};

      \node (oftenrare) at (8.9,7.0) {\strut $\leftarrow$ often rare $\rightarrow$};
      \node[fill=colora,draw=black,inner sep=4pt,anchor=east,left=0cm of oftenrare.west] {};
      \node[fill=colord,draw=black,inner sep=4pt,anchor=west,right=0cm of oftenrare.east] {};
