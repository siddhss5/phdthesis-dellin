...
\section{Family Problems in Manipulation Planning}
...
\cdnote{Add a formal problem definition here.}
...
\cdnote{start dump from proposal doc}

\section{The Family Planning Problem}
...
\subsection{Family Problem Formulation}
...
\subsection{Family Problems in Manipulation Tasks}
\label{sec:family:in-manipulation}
...
\section{Family as an Effort Model for Roadmap Planners}
...
\begin{algorithm}
\caption{Family PRM Planner}
\label{alg:family:prm}
\begin{algorithmic}[1]
...
\paragraph{A Family Ensemble Effort Model.}
...
\subsection{Behavior of the Family PRM}
...
\label{subsec:family:herb-experiment}
...
\cdnote{end dump from proposal doc}
