...
We capture the structure of the family motion planning problem
via an ensemble edge cost model $\mathcal{M}_{\ms{family}}$.
\marginnote{See Section~\ref{subsec:lemur:ensemble-edge-cost-models}
for a review of what constitutes an ensemble edge cost model.}
The model maintains
