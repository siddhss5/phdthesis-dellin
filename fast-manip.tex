...
and exploit structure between steps (Chapter~\ref{chap:multi-set}).
...
The Mult-Set PRM is the result of applying
...
Relation of batchiness to probabalistic model of C-space.
