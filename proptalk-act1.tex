...
\begin{frame}
   ...
   \begin{tikzpicture}
      ...
      \node[inner sep=0pt] at (6,4.75) {%
         \only<1>{\includegraphics[width=5cm]{build/e8-example/gen/intro}}%
         \only<2>{\includegraphics[width=5cm]{build/e8-example/gen/astar}}%
         \only<3>{\includegraphics[width=5cm]{build/e8-example/gen/wastar}}%
         \only<4>{\includegraphics[width=5cm]{build/e8-example/gen/e8}}%
      };
