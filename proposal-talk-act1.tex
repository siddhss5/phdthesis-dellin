...
\begin{frame}
   ...
   \begin{tikzpicture}
      ...
      \only<2->{
         \node[anchor=north,fill=black!10,rounded corners] at (3,7.5)
...
\begin{frame}
   ...
   \begin{tikzpicture}
      ...
      \node[align=center,fill=black!10,minimum width=4.8cm,rounded corners]
         at (4.85,7.25) {BFS over Vertices\\(implicit graphs)};
      \node[align=center,fill=black!10,minimum width=3cm,rounded corners]
      ...
      %\node[align=center,fill=black!10,rounded corners,minimum width=1.8cm,minimum height=0.4cm]
      %   at (1,5.9) {none};
      %\node[fill=black!5,rounded corners,minimum height=0.8cm,minimum width=2.8cm]
      %   at (4,5.9) {Dijkstra's};
      ...
      \node[fill=black!5,rounded corners,minimum height=0.8cm,minimum width=2.8cm]
         at (4,4.9) {A*};
      %\node[fill=black!5,rounded corners,minimum height=0.8cm,font=\scriptsize,align=center]
...
\begin{frame}
   ...
   \begin{center}
      \begin{tikzpicture}
         \draw[step=1,black!10,very thin,opacity=0] (0,0) grid (8,2);
...
\begin{frame}
   ...
   \begin{tikzpicture}
      ...
      \node[align=center,fill=black!10,rounded corners,minimum width=1.8cm,minimum height=0.4cm]
         at (1,3.9) {${\hat x}, {\hat p} \propto {\hat x}$};
      \node[fill=black!10,rounded corners,minimum height=0.8cm,minimum width=2.8cm]
         at (4,3.9) {Weighted A*};
      \only<2>{
