...
\begin{figure}[t]
   ...
   \subfloat[][A$^*$ search.\\
      ...
      \includegraphics{build/e8-example/gen/astar}
   }
   \vspace{0.05in}
...
\begin{marginfigure}
   \centering
   \includegraphics[width=1.5in]{build/roadmap-2d-densified}
...
\begin{genericfloat}
   ...
   \begin{minipage}[t]{0.49\linewidth}%
      ...
      \begin{algorithm}[H]
         ...
         \begin{algorithmic}[1]
         \Function {$x_{\ms{dist}}$}{$e$}
            \State \Return $|| q_e(1) - q_e(0) ||$
         \EndFunction
         \Function {$\hat{x}_{\ms{dist}}$}{$e$}
            \State \Return $|| q_e(1) - q_e(0) ||$
         \EndFunction
         \Function {$\hat{p}_{\ms{dist}}$}{$e$}
            \State \Return $0$
         \EndFunction
         \end{algorithmic}
      \end{algorithm}
...
\begin{marginfigure}
   ...
   \caption{
      Examples of paths for a 2D problem
...
\begin{figure}
   ...
   \subfloat[Plot of average collision checks vs solution path
         cost for the different algorithms.]{
      \includegraphics[width=0.8\textwidth]{build/maze-plot-ensemble}
   }
