   ...
   {herbbookshelf2/15.0/30}}
{
   ...
   \begin{axis}[
      ...
      \addplot
         ...
         table[x=python-totaltime-finmean,y=path-length-finmean]
         {data/lemur-sq/stats-byparam-\problem -lemurhaltonoffdens10000,2.0-lambda.txt};
      \addplot
         plot[thick,color=blue,mark=*,mark options={scale=0.25}]
         table[x=python-totaltime-finmean,y=path-length-finmean]
         {data/lemur-sq/stats-byparam-\problem -lemurnchaltonoffdens10000,2.0-lambda.txt};
   ...
   \begin{axis}[
      ...
      \addplot+
         ...
         table[x=lambda-u,y=utility-finmean-conloop]
         from {data/lemur-sq/stats-paramslice-\problem -lemur-nchaltonoffdens10000,2.0-scheduled-loop.txt};
      \addplot+
         plot[mark=none,color=black!20,fill=black!10,fill opacity=0.5]
         table[x=lambda-u,y=utility-finmean-conloop]
         from {data/lemur-sq/stats-paramslice-\problem -lemur-haltonoffdens10000,2.0-scheduled-loop.txt};
      ...
      %      table[x=lambda-u,y=utility-finmean]
      %      from {data/lemur-sq/stats-paramslice-\problem -lemur-nchaltonoffdens10000,2.0-\coeffstr .txt};
      %}
      \addplot+
         plot[solid,color=blue,mark=none,thick]
         table[x=lambda-u,y=utility-finmean]
         from {data/lemur-sq/stats-paramslice-\problem -lemur-nchaltonoffdens10000,2.0-scheduled.txt};
      \addplot+
         plot[densely dotted,color=blue,mark=none,thick]
         table[x=lambda-u,y=utility-finmean]
         from {data/lemur-sq/stats-paramslice-\problem -lemur-nchaltonoffdens10000,2.0-oracle.txt};
      ...
      %      table[x=lambda-u,y=utility-finmean]
      %      from {data/lemur-sq/stats-paramslice-\problem -lemur-haltonoffdens10000,2.0-\coeffstr .txt};
      %}
      \addplot+
         plot[solid,color=black,mark=none,thick]
         table[x=lambda-u,y=utility-finmean]
         from {data/lemur-sq/stats-paramslice-\problem -lemur-haltonoffdens10000,2.0-scheduled.txt};
      \addplot+
         plot[densely dotted,color=black,mark=none,thick]
         table[x=lambda-u,y=utility-finmean]
         from {data/lemur-sq/stats-paramslice-\problem -lemur-haltonoffdens10000,2.0-oracle.txt};
