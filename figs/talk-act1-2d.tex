...
\ifdefined\drawcfree
   ...
   \begin{scope}
      ...
      \draw[line width=3pt,rounded corners,fill=blue!20,opacity=\drawcfree] \crect;
      \draw[line width=3pt,opacity=\drawcfree] plot [smooth cycle] coordinates {\bloba};
   \end{scope}
   ...
   \begin{scope}
      ...
      \draw[line width=3pt,rounded corners,fill=blue!20,opacity=\drawcfree] \crect;
      \draw[line width=3pt,opacity=\drawcfree] plot [smooth cycle] coordinates {\blobb};
   \end{scope}
