...
\begin{scope}
   ...
   \foreach \s in {6,...,1}
   {
      ...
      \begin{scope}[shift={($(0.35*\s,3.5)$)}]
      
         \draw[black!20,fill=black!\s] (-5.0,-5.0) rectangle (0,0);
      
      \end{scope}
   }
\end{scope}

\node[text=black!50] at (0.17,0.85) {\tiny $+$};
\node[text=black!50] at (0.17,1.15) {\tiny $+$};
\node[text=black!50] at (1.89,0.85) {\tiny $-$};
\node[text=black!50] at (1.89,1.15) {\tiny $-$};
