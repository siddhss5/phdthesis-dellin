...
\node[fill=white,circle,inner sep=0] (f1lab) at (1.8,3.6) {$X_{12}$};
\node (f2lab) at (4.0,3.6) {$X_{23}$};
...
\node (p1lab) at (0.7,2.3) {$x_1$};
\node (p2lab) at (3.5,0.7) {$x_2$};
\node (p3lab) at (5.2,3.0) {$x_3$};
\draw[->] (p1lab) -- (p1);
\draw[->] (p2lab) -- (p2);
\draw[->] (p3lab) -- (p3);
