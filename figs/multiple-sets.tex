...
\draw[black!15,fill=black!2] (0,0) rectangle (4.0,3.0);
...
\node at ($ (a) + (0,0.8) $) {$\mathcal{C}_1$}; % A
\node at ($ (b) + (-0.6,-0.6) $) {$\mathcal{C}_2$}; % B
\node at ($ (c) + ( 0.6,-0.6) $) {$\mathcal{C}_3$}; % C

\node[circle,inner sep=1pt,fill=black!2,fill opacity=0.9]
  at (2.4,1.6) {$\mathcal{C}_q$}; % X_q
