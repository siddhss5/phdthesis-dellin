...
\begin{axis}[
   ...
   \addplot3[thick,fill=yellow,opacity=0.5] table[x=x, y=y, z expr=-1.5]
      {figs/family-composite/ptop-ro-intersection.txt};
   
   % draw path
   \addplot3[thick,smooth] table[x=x, y=y, z expr=-1.5] {figs/family-composite/path-transit1.txt};
   \node[inner sep=1pt,fill=black,circle] at (axis cs:0.20,0.80,-1.5) {}; % start
   \node[inner sep=1pt,fill=black,circle] at (axis cs:0.92,0.40,-1.5) {}; % grasp
...
%   \input{figs/family-composite/oe-ro-topview-draw-under}
   ...
   % part of ptop manifold BEHIND (or INSIDE OF) RxO, with boundary
   \begin{scope}
      \clip (axis cs:0.8,1.0,0.65) -- (axis cs:1.0,1.0,0.65) -- (axis cs:1.0,0.5,0.65) -- (axis cs:0.8,0.5,0.65) -- cycle;
      \input{figs/family-composite/ptop-ro-topview-draw-under}
      \draw[ultra thick,black] (axis cs:0.0,1.0,0.65) -- (axis cs:1.0,1.0,0.65) -- (axis cs:1.0,0.0,0.65);
   \end{scope}
   ...
   % part of ptop manifold IN FRONT OF RxO, with boundary
   \begin{scope}
      \clip (axis cs:0.8,1.0,0.65) -- (axis cs:1.0,1.0,0.65) -- (axis cs:1.0,0.5,0.65) -- (axis cs:0.8,0.5,0.65) -- cycle;
      \input{figs/family-composite/ptop-ro-topview-draw-over}
   \end{scope}
...
%      (axis cs:0.8,0.5,0.07) -- (axis cs:0.8,0.5,0.25) -- (axis cs:1.0,0.5,0.25) -- (axis cs:1.0,0.5,0.07) -- cycle;
   ...
   % part of ptop manifold BEHIND (or INSIDE OF) RxO
   \begin{scope}
      \clip (axis cs:0.0,1.0,0.65) -- (axis cs:0.8,1.0,0.65) -- (axis cs:0.8,0.5,0.65) -- (axis cs:1.0,0.5,0.65)
         -- (axis cs:1.0,0.0,0.65) -- (axis cs:0.0,0.0,0.65) -- cycle;
      \input{figs/family-composite/ptop-ro-topview-draw-under}
      \draw[ultra thick,black] (axis cs:0.0,1.0,0.65) -- (axis cs:1.0,1.0,0.65) -- (axis cs:1.0,0.0,0.65);
   \end{scope}
   ...
   % part of ptop manifold IN FRONT OF RxO
   \begin{scope}
      \clip (axis cs:0.0,1.0,0.65) -- (axis cs:0.8,1.0,0.65) -- (axis cs:0.8,0.5,0.65) -- (axis cs:1.0,0.5,0.65)
         -- (axis cs:1.0,0.0,0.65) -- (axis cs:0.0,0.0,0.65) -- cycle;
      \input{figs/family-composite/ptop-ro-topview-draw-over}
      \draw[ultra thick,black] (axis cs:1.0,0.35,0.65) -- (axis cs:1.0,0.0,0.65); % ugh
   \end{scope}
   ...
   \addplot3[thick,black] table[x=x, y=y, z=z] {figs/family-composite/ptop-ro-intersection.txt};
   % manually draw green box intersection boundary
   \addplot3[thick,black] coordinates { (0.8,1.0,0.65) (0.8,0.5,0.65) (1.0,0.5,0.65) };
   % front manifold boundary
   \addplot3[thick,black] coordinates { (0.0,1.0,0.65) (0.0,0.0,0.65) (1.0,0.0,0.65) };
   
   % draw path
   \addplot3[thick,smooth] table[x=x, y=y, z=z] {figs/family-composite/path-transit1.txt};
   \node[inner sep=1pt,fill=black,circle] at (axis cs:0.20,0.80,0.65) {}; % start
   \node[inner sep=1pt,fill=black,circle] at (axis cs:0.92,0.40,0.65) {}; % grasp
