...
\begin{marginfigure}
   ...
   \begin{tikzpicture}
      \node at (0,0) {
         $\arraycolsep=5pt%
         x_{\ms{feas}}[\xi] = \left\{ \begin{array}{cl}
...
$x_{\ms{dyn}} : \Xi \rightarrow \mathbb{R}$
intended to measure dynamical properties of the trajectory.
Common choices for $x_{\ms{dyn}}$ include
...
\marginnote{An optimal moption planner
   ...
   this objective is simply $x_{\ms{opt}} = x_{\ms{feas}} + x_{\ms{dyn}}$.
