...
\begin{frame}
   ...
   \node at (2.1,4.15) {\includegraphics[width=2.0cm]{figs/lazysp-herbarm/herbarm-path33.png}};
   \node at (2.1,5.5) {\footnotesize \textbf{ArmPlan}};

   \node[align=center] at (2.1,2.7) {$|V|=10^4$};



   \begin{scope}[shift={(5.5,4.3)}]
      \begin{axis}[
         width=7.0cm,
         height=4.0cm,
         xbar stacked,
