...
\begin{frame}
   ...
   \begin{tikzpicture}[font=\small]
      ...
      \only<5-7>{
         ...
         \only<7>{
            \node[fill=white,draw=blue!6,rounded corners] (gap330right) at (9,2.1) {\includegraphics{build/lazysp-selscores/gap3-30}};
         }
      }
      ...
      \node[fill=blue!2,draw=blue!10,rounded corners] at (9,1.9) {\begin{minipage}{5.1cm}
         ...
         \begin{equation*}
            \arraycolsep=1pt
            \begin{array}{ll}
            \mathcal{D}_p : & \mbox{path distribution with p.m.f. } \\
...
\begin{frame}
   ...
   \begin{tikzpicture}[font=\small]
      ...
      \node[fill=black!5,draw=black!10,rounded corners,align=center] at (10.5,6.8) {
         Expand = A*\\
         Forward = LWA*
      };
      }
